...
public record ErrorResponseDto (
    ...
    public static ErrorResponseDto fromException(BaseException ex, String path, String requestId) {
    ...
    public static ErrorResponseDto fromMessage(String errorCode, int status,
